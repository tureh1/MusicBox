...
public class MainActivity extends AppCompatActivity {
    ...
    private Button logoutButton; //defined logout button variable
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoutButton = findViewById(R.id.main_logout_btn); //link to logout button in main activity xml
        ...
        logoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MainActivity.this, LoginActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK); // starts new task or Clears current task
                startActivity(intent);
            }
        });
    }
