...
public class JsonArrReqActivity extends AppCompatActivity {
    ...
    private static final String URL_JSON_ARRAY = "https://d1f9a305-ec1e-4421-95c4-f6cbd4aac0e8.mock.pstmn.io/users";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                ListItemObject item = new ListItemObject(name, email, phone);
                                adapter.add(item);
